...
export default function Navigation() {
    return (
        <ul className={"m-0 pe-1 d-flex align-items-center gap-2"}>
                ...
                <NavLink to="/contact" className={({isActive}) => isActive ? 'active h-100 d-flex align-items-center' : 'h-100 d-flex align-items-center'}>Contact</NavLink>
